      ...
      <div className="aboutPage__layout">
        <div className="aboutPage__text-contain">
          <p className="aboutPage__paragraph1">
            ...
            learning, exploring the natural world through recreation and observation,
            and most things tech. I find the intersections of my
            interests as fuel for learning and creativity. I'm a self motivated doer that loves
